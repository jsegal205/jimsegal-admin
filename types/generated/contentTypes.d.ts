...
export interface ApiDestinationDestination extends Schema.CollectionType {
  ...
  attributes: {
    ...
    destination_visits: Attribute.Relation<
      'api::destination.destination',
      'oneToMany',
      'api::destination-visit.destination-visit'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiDestinationVisitDestinationVisit
  extends Schema.CollectionType {
...
export interface ApiGameGame extends Schema.CollectionType {
  ...
  attributes: {
    ...
    bgg_id: Attribute.Integer & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiRecipeRecipe extends Schema.CollectionType {
  ...
  attributes: {
    ...
    referenceLink: Attribute.String;
    ingredients: Attribute.RichText & Attribute.Required;
    directions: Attribute.RichText & Attribute.Required;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::destination-visit.destination-visit': ApiDestinationVisitDestinationVisit;
